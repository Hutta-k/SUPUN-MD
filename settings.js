...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'SUPUN-MD=qFE0yapC#-lkmqnfEQw5kjzHs46-Q3XtsZBDhDoueY3FtzgKiq3g' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '48729758384' : process.env.OWNER_NUMBER,
